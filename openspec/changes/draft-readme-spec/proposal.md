...
- `resolution`: eligibility is "not retired" rather than `status: active`; RESOLUTION records carry `source`.
...
- Six of seven capability specs change. `temporal-primitives` is untouched.
